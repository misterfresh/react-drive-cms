        ...
        >
            ...
            <form class="form">
                <div>
                    ...
                    ${name.error &&
                    html` <span class="error"> ${name.error} </span> `}
                    <${BaseInput}
                        value=${name.value}
                        name="name"
                ...
                <div>
                    ...
                    ${email.error &&
                    html` <span class="error"> ${email.error} </span> `}
                    <${BaseInput}
                        value=${email.value}
                        name="email"
                ...
                <div>
                    ...
                    ${company.error &&
                    html` <span class="error"> ${company.error} </span> `}
                    <${BaseInput}
                        value=${company.value}
                        name="company"
                ...
                <div>
                    ...
                    ${phone.error &&
                    html` <span class="error"> ${phone.error} </span> `}
                    <${BaseInput}
                        value=${phone.value}
                        name="phone"
